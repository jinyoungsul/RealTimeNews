...
$(function(){
	...
	$(document).ready(function(){
		$('#update-account').slideUp('slow');
	})
	$('#upAndDown').click(function(){
		$('#update-account').toggle('slow');
	})
});
					...
					<div class="panel-body">
						<div class="row">
							...
							<div id="update-account">
								...
								<div id="updateResult">
									<c:if test="${updateResult==true}"><p class = "success">회원정보 수정을 완료하였습니다. 상단의 아이콘을 통해 메인으로 이동하십시오.
																	<br>혹은 하단의 아이콘을 통해 수정을 계속할 수 잇습니다.</p>
																	<button id="upAndDown" class="btn btn-default"><i class="glyphicon glyphicon-pencil navy"></i></button>
									</c:if>
								</div>
							</div>
						</div>
